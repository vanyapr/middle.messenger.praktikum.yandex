    ...
    <div class="settings__container">
      ...
      <form class="settings__form"  onsubmit="{{ handleSubmit }}" novalidate>
        <div class="settings__group">
          <input class="settings__value" name="login" id="login" type="text" placeholder=" " value="testuser" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ loginValidator }}" required>
        ...
        <div class="settings__group">
          <input class="settings__value" name="email" id="email" type="text" placeholder=" " value="noreply@example.com" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ emailValidator }}" required>
        ...
        <div class="settings__group">
          <input class="settings__value" name="display_name" id="display_name" type="text" placeholder=" " value="Иван" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ nameValidator }}" required>
          <label for="display_name" class="settings__label">Имя в чате (никнейм)</label>
          <div class="settings__error">Минимум 4 буквы, цифры или символы '-' и '_', </div>
        </div>
        <div class="settings__group">
          <input class="settings__value" name="first_name" id="first_name" type="text" placeholder=" " value="Иван" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ nameValidator }}" required>
          <label for="first_name" class="settings__label">Ваше имя</label>
          <div class="settings__error">Введите имя с Заглавной буквы</div>
        </div>
        <div class="settings__group">
          <input class="settings__value" name="last_name" id="last_name" type="text" placeholder=" " value="Иванов" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ nameValidator }}" required>
        ...
        <div class="settings__group">
          <input class="settings__value" name="phone" id="phone" type="text" placeholder=" " value="+71231234567" onfocus="{{ validate }}" onkeyup="{{ validate }}" pattern="{{ phoneValidator }}" required>
